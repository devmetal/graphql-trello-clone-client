...
const lorem =
  'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nec tempus mi. Nulla nec enim nec libero congue elementum ut.';
...
storiesOf('Button', module).add('button with text', () => (
  <Button onClick={action('clicked')}>Hello Button</Button>
));

storiesOf('Card', module)
  .addDecorator(story => <div style={{ width: '300px' }}>{story()}</div>)
  .add('simple card', () => <Card title="Card title">Card children</Card>)
  .add('simple card with more text', () => (
    <Card title="Card title">{lorem}</Card>
  ))
  .add('TicketCard', () => (
...
storiesOf('Boards', module).add('Boards', () => <Boards boards={boards} />);
